...
const NewsletterReserve = () => {
    ...
    return (
        <section className="flex flex-col mx-3 gap-3 md:!mx-8 text-white sm:flex-row">
            ...
            <article className="min-h-250px md:w-1/2 rounded bg-primaire p-6 md:px-16 xl:px-36">
                ...
                <div className="flex flex-col max-w-sm mx-auto">
                    ...
                    <input className="px-3 py-1 mx-auto w-60 text-xs rounded border border-white relative bg-primaire text-center" type="email" placeholder="Renseignez votre adresse email"/>
                    <button onClick={(e) => subscribeToNewsletter(e)} className={clickSubscribe === "Merci !" ? "px-3 rounded py-1 mt-4 mx-auto w-60 text-md border border-white relative bg-tertiary" : "px-3 rounded py-1 mt-4 mx-auto w-60 text-md border border-white relative bg-primaire"}>{clickSubscribe}</button>
                </div>
