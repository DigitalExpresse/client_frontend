            ...
            <div className="navbar fixed z-40 px-3 md:!px-8 py-2 flex justify-between items-center w-full bg-white md:py-3">
                ...
                <div className={ navbarOpen ? "fadeIn bg-dark text-white absolute pt-14 top-14 left-0 w-full text-center sm:hidden h-screen" : "hidden" }>
                    ...
                    <div className="flex justify-center mt-2">
                        <a className='hover:!text-tertiary instagram-logo' href={String(restaurantInfo.socialNetworks[0])}>
                            <i className="bi bi-instagram text-2xl mx-2"></i>
                        </a>
                        <a className={"'facebook-logo"} href={String(restaurantInfo.socialNetworks[1])}>
