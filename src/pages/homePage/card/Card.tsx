...
const Card = () => {
    ...
    return (
            <section className="section-card w-full text-white my-3 px-3 md:!px-8 flex flex-col-reverse sm:flex-row-reverse relative">
                ...
                <article className="menu-img w-full sm:w-1/2 min-h-250px !bg-cover object-cover flex justify-center">
                ...
                <article className="bg-primaire p-6 sm:min-h-150px w-full sm:w-1/2">
