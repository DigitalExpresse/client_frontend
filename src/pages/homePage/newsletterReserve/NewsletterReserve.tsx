        ...
        <section className="flex flex-col mx-3 md:!mx-8 text-white sm:flex-row">
            ...
            <article className="min-h-250px md:w-1/2 bg-primaire p-6 md:px-16 xl:px-36">
                ...
                <div className="flex flex-col mt-4">
                    <p className="text-center opacity-80">{textSection.newsletterReserveText}</p>
            ...
            <article className="min-h-250px md:w-1/2 bg-secondaire p-6 md:px-16 xl:px-36">
                <h3 className="text-xl text-center pb-2 2xl:pb-6 md:text-3xl">Newsletter</h3>
                <hr className="w-40 m-auto"/>

                <div className="flex flex-col mt-4">
                    <p className="text-center opacity-80">{textSection.newsletterText}</p>
                    <input className="px-3 py-1 mt-4 mx-auto w-60 text-xs border border-white relative bg-primaire text-center" type="email" placeholder="Renseignez votre adresse email"/>
